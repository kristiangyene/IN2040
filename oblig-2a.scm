...
;;2b)
;Halerekursiv versjon av decode i huffman.scm
...
#|TODO ----- gjøre ferdig
Mye av de resterende oppgavene er avhengig av denne modetoden så var synt jeg ikke fikk den til.
;;2d)
...
;;2e)
;Lager huffantre ut av en liste med frekvens-par
...
;Disse spørsmålene tror jeg er avhengig av encode metode..




;;2g
;Det motsatte av oppgave 2e. Lager frekvenspar ut av et tre.
